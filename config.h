...
/* Name of package */
#define PACKAGE "ybcminer"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "mikaelh@mbnet.fi"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ybcminer"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ybcminer 3.3.1-yac2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ybcminer"
...
/* Major version */
#define YBCMINER_MAJOR_VERSION 3

/* Micro version */
#define YBCMINER_MINOR_SUBVERSION 1

/* Minor version */
#define YBCMINER_MINOR_VERSION 3

/* Path to ybcminer install */
#define YBCMINER_PREFIX "/usr/local/bin"
